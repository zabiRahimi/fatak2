...
class Save_editPro extends FormRequest
{
    /**
     ...
     */
     ...
     public function rules()
     {
         return [
           ...
           'order_id' =>'required_if:checkInset,1|nullable|numeric',
           'img_id' =>'required|numeric',
           'stamp' =>'required_if:checkAddOrEditStamp,1,2|nullable|numeric',//در جدول stampProOrders ذخیره می شود .
           'namePro'=>'required',
           'maker'=>'nullable',
           'brand'=>'nullable',
           'model'=>'nullable',
