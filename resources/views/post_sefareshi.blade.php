<?php
  Session::put('add_city' , $city );//جهت نمایش شهر در فاکتور خرید
...
$gram_end=$gram . 'g';
foreach ($post_sefareshi->where('id' , $id_javar ) as $post) {
$price_post= $post->$gram_end + Session::get('pakat' . $id1) ;
$price_post2[]=$price_post;
Session::put('price_sefareshi_one' . $id1 , $price_post);//جهت ذخیره قیمت پست یک محصول در دیتابیس
}
}
Session::put('post_sefareshi' ,array_sum($price_post2) );
