...
<div class="menu_small_2 dashSh_small_2">
  ...
  <ul class="menu_small_ul">
    ...
    <a href="/oldOrderShop"class="apjax" onclick="hide_menu_small('dashSh_scroll');"><span class="liMM"><li class="modal_hide "><span class=""><i class="fas fa-file-invoice"></i> محصولات پیشنهاد شده</span></li></span> <span class="badgeShopMob">{{$oldOrderNum}}</span></a>
...
<div class="dashShContent">
  <div class="dashSh_R">
    <ul class="ul_right dashSh_RUl">
      ...
      <a href="/sabtProStockShop"class=""><li class="modal_hide" onclick=""><span><i class="fas fa-calendar-plus"></i>ثبت محصولات ثابت</span> </li></a>
      <a href="/showProStockShop"class="apjax"><li class="modal_hide" onclick=""><span><i class="fas fa-circle"></i>محصولات ثابت</span> <span class="badgeShop">{{$proStockNum}}</span></li></a>
      ...
      <a href="/showProUnStockShop"class="apjax"><li class="modal_hide" onclick=""><span><i class="far fa-circle"></i>محصولات غیر ثابت </span> <span class="badgeShop">{{$proUnStockNum}}</span></li></a>
      ...
      <a href="/oldOrderShop"class="apjax"><li class="modal_hide" onclick=""><span><i class="fas fa-file-invoice"></i> محصولات پیشنهاد شده </span> <span class="badgeShop">{{$oldOrderNum}}</span></li></a>
