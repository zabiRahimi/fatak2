...
<div class="dashShContent">
  <div class="dashSh_R">
    <ul class="ul_right dashSh_RUl">
      ...
      <a href="/showProStockShop"class="apjax"><li class="modal_hide" onclick=""><span><i class="fas fa-circle"></i>محصولات ثابت</span> <span class="badgeShop">{{$orderNum}}</span></li></a>
      ...
      <a href="/showProUnStockShop"class="apjax"><li class="modal_hide" onclick=""><span><i class="far fa-circle"></i>محصولات غیر ثابت </span> <span class="badgeShop">{{$orderNum}}</span></li></a>
