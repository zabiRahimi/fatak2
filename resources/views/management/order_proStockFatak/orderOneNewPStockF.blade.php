    ...
    <div class="modal-dialog modal-lg modal-xl" role="document">
      <div class="modal-content">
        ...
        <div class="orderAghdamModal3">
            <button type="button" class="btn btn-primary"onclick="orderAghdamNSF({{$buy->id}})" data-dismiss="modal"  aria-label="Close">بله</button>
  ...
  <div class="modal fade" id="orderDelModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-xl" role="document">
      <div class="modal-content">
        ...
        <div class="orderAghdamModal3">
            <button type="button" class="btn btn-primary"onclick="delBuyOrderNSF({{$buy->id}},'orderNewPStockF')" data-dismiss="modal"  aria-label="Close">بله</button>
            <button type="button" class="btn btn-danger" data-dismiss="modal"  aria-label="Close">خیر</button>
        </div>
      </div>
    </div>
