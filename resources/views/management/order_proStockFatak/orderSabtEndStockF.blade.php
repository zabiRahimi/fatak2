    ...
    <form class="form formAdmin formCodePA" id="form_sabtCodePSh" action="" method="post">
       ...
       <div class="form-group textAll divFormCodePA">
        ...
        <div class="form-group divSabtForm">
          <button type="button" class="btn btn-success" onclick="orderSabtEndStockF()" >ثبت و جستجو</button>
        </div>
      </form>
      @if (!empty($buy_id))
        <div class="div_body ">
        ...
        <div class="orderAghdam">
          <button type="button"class="btn btn-success orderAghdam1"onclick="editStageOrderNSF({{$buy->id}} , 5 , {{$buy->code_rahgiry}}, '{{$buy->date_post}}','orderSabtEndStockF')">به عنوان سفارش تحویلی ثبت شود</button>
        </div>
