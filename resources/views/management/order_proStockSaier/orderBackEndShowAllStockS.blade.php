  ...
  <div class="divRow">
    ...
    @foreach ($buy as $buys)
      ...
      <div class="divRow2 all_edit_pro3 {{$classBg}} ">
        ...
        <a href="/showShopProStockS/{{$shop2->id}}/orderBackEndShowAllStockS"><div class="divRow3 orderErsalPSS3">{{$shop2->shop}}</div></a>
        ...
        <a href="/orderBackEndShowOneStockS/{{$buys->id}}"><div class="divRow3 orderErsalPSS6">مشاهده</div></a>
