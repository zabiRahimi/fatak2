     ...
     <div class="form-group textAll ">
      ...
      <div class="form-group textAll ">
       ...
       <div class=" textareaEditor">
         ...
         <textarea class="editor"name="" id="buyerDisBack">{{$backPro->buyer_dis }}</textarea>
       </div>
       <div class=" textareaEditor">
         ...
         <textarea class="editor"name="" id="technicianDisBack">{{$backPro->technician_dis}}</textarea>
       </div>
       <div class="form-group textAll ">
      ...
      <div class="form-group divSabtForm">
        <button type="button" class="btn btn-success" onclick="orderBackEditStockS({{$backPro->id}})" >ثبت تغییرات</button>
      </div>
    </form>
    ...
    <div class="modal-dialog modal-lg modal-xl" role="document">
      <div class="modal-content">
        ...
        <div class="orderAghdamModal3">
            <button type="button" class="btn btn-primary"onclick="delOrderBackStockS({{$buy->id}},{{$backPro->id}},'','orderBackShowAllStockS')" data-dismiss="modal"  aria-label="Close">بله</button>
  ...
  <div class="modal fade" id="orderDelModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-xl" role="document">
      <div class="modal-content">
        ...
        <div class="orderAghdamModal3">
            <button type="button" class="btn btn-primary"onclick="delOrderBackStockS({{$buy->id}},{{$backPro->id}},'ok','orderBackShowAllStockS')" data-dismiss="modal"  aria-label="Close">بله</button>
            <button type="button" class="btn btn-danger" data-dismiss="modal"  aria-label="Close">خیر</button>
        </div>
      </div>
    </div>
